...
[TestFixture]
public class WithoutInterceptorAndReferenceTestsAlternate
{
    AssemblyWeaver assemblyWeaver;
    FieldInfo methodBaseField;

    public WithoutInterceptorAndReferenceTestsAlternate()
    {
        var assemblyPath = Path.GetFullPath(@"..\..\..\AssemblyToProcess\bin\DebugWithoutInterceptorAndReferenceAlternate\AssemblyWithoutInterceptorAndReferenceAlternate.dll");
        ...
        assemblyWeaver = new AssemblyWeaver(assemblyPath, "AlternateAttribute", new List<string> { assemblyToReference });

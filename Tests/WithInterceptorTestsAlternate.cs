...
[TestFixture]
public class WithInterceptorTestsAlternate
{
    AssemblyWeaver assemblyWeaver;
    FieldInfo methodBaseField;

    public WithInterceptorTestsAlternate()
    {
        var assemblyPath = Path.GetFullPath(@"..\..\..\AssemblyToProcess\bin\DebugWithInterceptorAlternate\AssemblyWithInterceptorAlternate.dll");

...
[TestFixture]
public class WithoutInterceptorTestsAlternate
{
    AssemblyWeaver assemblyWeaver;

    public WithoutInterceptorTestsAlternate()
    {
        var assemblyPath = Path.GetFullPath(@"..\..\..\AssemblyToProcess\bin\DebugWithoutInterceptorAlternate\AssemblyWithoutInterceptorAlternate.dll");
